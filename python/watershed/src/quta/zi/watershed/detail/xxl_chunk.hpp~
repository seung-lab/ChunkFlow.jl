...
private:
    ...
    shared_ptr< watershed::file > connfile_;
    sizes_type connfoff_;
    shared_ptr< watershed::file > segfile_;
    sizes_type segfoff_;
...
public:
    ...
    xxl_chunk( std::size_t xpos,
               ...
               shared_ptr< watershed::file > connf,
               size_type connoff,
               shared_ptr< watershed::file > segf,
               size_type segoff )
        : xpos_( xpos ),
          ypos_( ypos ),
          zpos_( zpos ),
    ...
    {
        //segfile_->write( chunk_->data(),
        //chunk_->size() * sizeof( id_type ),
        //segfoff_ );

        mmap_file::write( prefix_ + ".seg", chunk_->data(), chunk_->size() * sizeof( id_type ) );
    ...
    {
        chunk_->allocate();
        mmap_file::read( prefix_ + ".seg", chunk_->data(), chunk_->size() * sizeof( id_type ) );
        //segfile_->read( chunk_->data(),
        //chunk_->size() * sizeof( id_type ),
        //segfoff_ );
        return chunk_;
    }
